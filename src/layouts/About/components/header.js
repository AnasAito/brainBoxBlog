...
export const PrimaryLink = tw(NavLink)`
  lg:mx-0
  px-8 py-3 rounded  text-gray-500
...
export default ({
  ...
  const defaultLinks = [
    <NavLinks key={1}>
      ...
      <PrimaryLink
        className="rounded-full cursor-pointer nm-flat-gray-200 hover:nm-flat-gray-200-lg leading-5 px-8 py-4 uppercase font-bold tracking-widest transition duration-200 ease-in-out transform hover:scale-110"
        onClick={() =>
          history.push({
            pathname: `/about`,
          })
