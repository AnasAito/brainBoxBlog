...
export default function WizardCard({ handleClick, value, path }) {
  return (
    <div>
      <span>{value}</span>
      <div className="rounded-lg border-dashed border-gray-300 border-4 h-40 min-h-full flex justify-center items-center">
        <svg
          onClick={handleClick}
          version="1.1"
          id="Capa_1"
          ...
          y="0px"
          viewBox="0 0 496 496"
          className="h-20 w-20 text-green-700 cursor-pointer hover:text-green-500"
          fill="currentColor"
        >
          <g>
            <g>
